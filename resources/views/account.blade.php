<x-main title="تنظیمات حساب" icon="/assets/media/icons/face-scan.png">
  ...
  <div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
      <!--begin::Form-->
      <form id="kt_account_profile_details_form" method="POST" class="form" action="/profile">
        @csrf
        <!--begin::کارت body-->
        <div class="card-body border-top p-9">
          ...
          <div class="row mb-6">
            ...
            <div class="col-lg-8">
              <!--begin::Col-->
              <input type="text" name="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="نام" value="{{ $user->name }}" />
              <!--end::Col-->
            </div>
            <!--end::Col-->
          </div>
          ...
          <div class="row mb-6">
            <!--begin::Tags-->
            <label class="col-lg-4 col-form-label required fw-semibold fs-6">شماره همراه</label>
            <!--end::Tags-->
            <!--begin::Col-->
            <div class="col-lg-8">
              <!--begin::Col-->
              <input type="text" name="mobile" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="شماره همراه" value="{{ $user->mobile }}" />
              <!--end::Col-->
            </div>
            <!--end::Col-->
          </div>
          ...
          <div class="row mb-6">
            <!--begin::Tags-->
            <label class="col-lg-4 col-form-label required fw-semibold fs-6">ادرس ایمیل</label>
            <!--end::Tags-->
            <!--begin::Col-->
            <div class="col-lg-8">
              <!--begin::Col-->
              <input type="text" name="email" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="ادرس ایمیل" value="{{ $user->email }}" />
              <!--end::Col-->
            </div>
            <!--end::Col-->
          </div>
  ...
  <div class="card mb-5 mb-xl-10  d-none">
    ...
    <!--begin::کارت header-->
    <!--begin::Content-->
    <div id="kt_account_settings_profile_details" class="collapse">
      <!--begin::Form-->
