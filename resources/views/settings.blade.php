    ...
    <div class="card-header border-0">
      ...
      <form method="POST" class="form" action="/settings">
        ...
        <div class="card-body border-top p-9">
            ...
            <div class="col-lg-8">
                <!--begin::Col-->
                <select name="config[status_place_payment]" class="form-select form-select-solid" data-minimum-results-for-search="Infinity"  data-control="select2" data-close-on-select="true" data-placeholder="انتخاب کنید" data-allow-clear="false" >
            ...
            <div class="col-lg-8">
                <!--begin::Col-->
                <select name="config[sales_price_field]" class="form-select form-select-solid" data-minimum-results-for-search="Infinity"  data-control="select2" data-close-on-select="true" data-placeholder="انتخاب کنید" data-allow-clear="false">
            ...
            <div class="col-lg-8">
                <!--begin::Col-->
                <select name="config[special_price_field]" class="form-select form-select-solid" data-minimum-results-for-search="Infinity"  data-control="select2" data-close-on-select="true" data-placeholder="Select" data-allow-clear="false">
            ...
            <div class="col-lg-8">
                <!--begin::Col-->
                <select name="config[wholesale_price_field]" class="form-select form-select-solid" data-minimum-results-for-search="Infinity"  data-control="select2" data-close-on-select="true" data-placeholder="انتخاب کنید" data-allow-clear="false">
            ...
            <div class="col-lg-8">
                <!--begin::Col-->
                <select name="config[product_stock_field]" class="form-select form-select-solid" data-minimum-results-for-search="Infinity"  data-control="select2" data-close-on-select="true" data-placeholder="انتخاب کنید" data-allow-clear="false">
                <option></option>
                <option value="1" @selected($user->config->product_stock_field == "1")>موجودی کل</option>
                <option value="2" @selected($user->config->product_stock_field == "2")>موجودی با کسر خورده فروشی و پیش فاکتور</option>
            ...
            <!--begin::Tags-->
                ...
                <div class="col-lg-8">
                    <!--begin::Col-->
                    <select name="config[save_sale_invoice]" class="form-select form-select-solid" data-minimum-results-for-search="Infinity"  data-control="select2" data-close-on-select="true" data-placeholder="انتخاب کنید" data-allow-clear="false">
                    <option></option>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8">
                    <!--begin::Col-->
                    <select name="config[save_pre_sale_invoice]" class="form-select form-select-solid" data-minimum-results-for-search="Infinity"  data-control="select2" data-close-on-select="true" data-placeholder="انتخاب کنید" data-allow-clear="false">
                    <option></option>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8">
                    <!--begin::Col-->
                    <select name="config[update_product_price]" class="form-select form-select-solid" data-minimum-results-for-search="Infinity"  data-control="select2" data-close-on-select="true" data-placeholder="انتخاب کنید" data-allow-clear="false">
                    <option></option>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8">
                    <!--begin::Col-->
                    <select name="config[update_product_stock]" class="form-select form-select-solid" data-minimum-results-for-search="Infinity"  data-control="select2" data-close-on-select="true" data-placeholder="انتخاب کنید" data-allow-clear="false">
                    <option></option>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8">
                    <!--begin::Col-->
                    <select name="config[update_product_name]" class="form-select form-select-solid" data-minimum-results-for-search="Infinity"  data-control="select2" data-close-on-select="true" data-placeholder="انتخاب کنید" data-allow-clear="false">
                    <option></option>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8">
                    <!--begin::Col-->
                    <select name="config[insert_new_product]" class="form-select form-select-solid" data-minimum-results-for-search="Infinity"  data-control="select2" data-close-on-select="true" data-placeholder="انتخاب کنید" data-allow-clear="false">
                    <option></option>
    ...
    <div class="card-header border-0">
      ...
      <div class="card-body border-top p-9">
        ...
        <div class="row mb-6">
          ...
          <div class="col-lg-8">
            <!--begin::Col-->
            <input type="text" name="config[product_shipping]" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="وارد کنید" value="" />
            <!--end::Col-->
          </div>
          <!--end::Col-->
        </div>
        ...
        <div class="row mb-6">
          ...
          <div class="col-lg-8">
            <!--begin::Col-->
            <input type="number" name="customer_sarfasl" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="شماره سرفصل حساب مشتری وارد کنید" value="{{ $user->customer_sarfasl }}" />
            <!--end::Col-->
          </div>
          <!--end::Col-->
        </div>
