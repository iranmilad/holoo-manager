        ...
        <table id="technicalreporting_table_2" class="table table-striped table-row-bordered gy-5 gs-7">
          ...
          @foreach ($invoices as $invoice)
            <tr>
              ...
              <td class="text-start">
              <i class="ki-duotone ki-{{ $invoice->status != 'ثبت سفارش فروش انجام شد' ? 'cross' : 'check' }}-circle fs-1 {{ $invoice->status != 'ثبت سفارش فروش انجام شد' ? 'text-danger' : 'text-success' }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $invoice->status }}">
                  <span class="path1"></span>
                  <span class="path2"></span>
                </i>
              </td>
